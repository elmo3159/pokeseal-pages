...
<header class="topbar"><div class="topbar-in">
  ...
  <a class="top-cta" href="${SITE}/oshi-calendar/">アプリで見る</a>
</div></header>
<div class="wrap">
${body}
<footer>
...
function roomPage(room, data) {
  ...
  body += `<a class="cta rv" href="${SITE}/oshi-calendar/">
    <span class="big">📲 推しカレアプリでリマインドを受け取る</span>
    <small>予定の直前に通知が届く／みんなで実況しながら応援</small>
  </a>`;
...
function hubPage(rooms) {
  ...
  <a class="cta rv" href="${SITE}/oshi-calendar/">
    <span class="big">📲 推しカレアプリをはじめる</span>
    <small>推しの予定を絶対に逃さない・みんなで実況</small>
  </a>`;
  return pageShell({
